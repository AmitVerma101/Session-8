...
//         if(tArea.value.trim()!='' && image.value!=''){
//             saveToDo(tArea.value.trim(),image.value,function(val){
//                  displayToDo(val);
//                 console.log("success");
//             })
...
// }
// function saveToDo(val,val2,callback){
//         let request=new XMLHttpRequest;
//         request.open('POST','/savetodo');
//         request.setRequestHeader("Content-Type","application/json");
//         let obj={id:i,task:val,image:val2,checked:false};
//         console.log(obj);
...
function displayToDo(value){
    ...
    let str=document.createElement("div");
      ...
      if(value.checked==true){
         ...
         <img src="${value.image}" alt="Alternate text" width="20" height="20">
